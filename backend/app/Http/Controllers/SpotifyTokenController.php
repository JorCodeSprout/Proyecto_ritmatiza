...
class SpotifyTokenController extends Controller {
    ...
    //  * RUTA: /api/spotify-token
    //  */
    // public function getSpotifyToken(Request $request) {
    //     try {
    //         // El servicio maneja la obtención del token usando Cliente Credentials Flow
    ...
    //         response()->json(['error' => 'Error interno al procesar el token de Spotify'], 500);
    //     }
    // }
